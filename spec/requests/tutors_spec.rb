...
RSpec.describe Api::V1::TutorsController, type: :request do
  describe 'POST/create tutor' do
    it 'Should log in' do 
      get 'http://127.0.0.1:3000//api/v1/tutors'
    ...
    it 'Should not create a tutor' do 
      post '/api/v1/tutors', headers: @headers, as: :json, params: { name: '', image: 'image1.com', speciality: 'speciality1', bio: 'bio1'}
    ...
    it 'Should get a specific tutor' do 
      tutor = Tutor.create(id: "1", name: 'tutor1', image: 'image1.com', speciality: 'speciality1', bio: 'bio1', price: 100)
    ...
    it 'Should update a tutor' do 
      tutor = Tutor.create(id: "1", name: 'tutor2', image: 'image1.com', speciality: 'speciality1', bio: 'bio1', price: 100)
