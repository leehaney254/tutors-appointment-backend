...
RSpec.describe Api::V1::TutorsController, type: :request do
  describe 'POST/create tutor' do
    ...
    it 'Should get a specific tutor' do
      Tutor.create(id: '1', name: 'tutor1', image: 'image1.com', speciality: 'speciality1', bio: 'bio1',
                   price: 100)
    ...
    it 'Should update a tutor' do
      Tutor.create(id: '1', name: 'tutor2', image: 'image1.com', speciality: 'speciality1', bio: 'bio1',
                   price: 100)
