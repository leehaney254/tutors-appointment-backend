...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference("Tutor.count") do
      post tutors_url, params: { tutor: { bio: @tutor.bio, image: @tutor.image, name: @tutor.name, price: @tutor.price, speciality: @tutor.speciality } }, as: :json
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { bio: @tutor.bio, image: @tutor.image, name: @tutor.name, price: @tutor.price, speciality: @tutor.speciality } }, as: :json
    assert_response :success
  end
